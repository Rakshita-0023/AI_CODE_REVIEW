      ...
      <div className="flex border-b border-white/10 relative">
        {tabs.map((tab) => (
          <button
            ...
            className={`px-6 py-3 text-sm font-semibold border-b-2 transition-all duration-300 ease-out relative z-10 ${activeTab === tab.id
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center space-x-2 mb-1">
                          ...
                          <span className={`px-2 py-1 text-xs rounded-full ${issue.severity === 'high' ? 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-200' :
