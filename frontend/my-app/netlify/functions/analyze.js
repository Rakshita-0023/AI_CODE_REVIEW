...
export const handler = async (event, context) => {
    ...
    try {
      ...
      Return ONLY a raw JSON object (no markdown formatting, no backticks) with the following structure:
      {
        ...
        "fixedCode": "The fully corrected code",
        ...
        "optimizations": [
          {
            ...
            "optimizedCode": "Snippet of optimized code"
          }
        ],
        "alternatives": [
          {
      ...
      Ensure the JSON is valid and strictly follows this format. Handle any syntax errors gracefully by reporting them in the 'issues' array.
    `;
